...
import { FlatList, ScrollView, View, ViewPropTypes, Dimensions } from "react-native";
...
class Column extends React.Component {
	...
	render() {
		return <View style={{ flex: 1, overflow: "hidden" }}>
			<FlatList
				style={{ width: windowWidth / 2 - 30, height: "100%" }}
...
export default class Masonry extends React.Component {
	...
	render() {
		return <ScrollView {...this.props}>
			{this.props.header}
	<View style={[{ flexDirection: "row", marginLeft: 20 }, this.props.containerStyle]}>
